...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """ 
    print("")
    print("Final Statistics " + "MODEL USED: {} " .format(model) + "Number of images: {} ".format(results_stats_dic['n_images']))
    print("No. of NOT DOG Images: {} ".format(results_stats_dic['n_notdogs_img']) +  "and No. of Correct DOG images{}".format(results_stats_dic['n_dogs_img']))
    ...
    if (print_incorrect_dogs and 
        ( (results_stats_dic['n_notdogs_img'] + results_stats_dic['n_dogs_img'])
